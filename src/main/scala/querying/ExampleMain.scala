...
import querying.main.{QueryingUtils, OrganizationConstants}
...
*/
    ...
    val result = QueryingUtils.convertRdf2Result(resultSet)
    ...
    val result2 = QueryingUtils.convertRdf2Result(resultSet2)
    ...
    val result3 = QueryingUtils.convertRdf2Result(resultSet3)
    ...
    val result4 = QueryingUtils.convertRdf2Result(resultSet4)
